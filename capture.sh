...
snapshot () {
    ...
    ffmpeg -f video4linux2 -i /dev/video1 -vframes 5 -q:v 1 -video_size 1024x768 /tmp/video%3d.jpeg
    mv /tmp/video005.jpeg ${DESTINATION_DIR}/video1.jpeg
    rm /tmp/video00*.jpeg
    ...
    ffmpeg -f video4linux2 -i /dev/video0 -vframes 5 -q:v 1 -video_size 1024x768 /tmp/video%3d.jpeg
    mv /tmp/video005.jpeg ${DESTINATION_DIR}/video0.jpeg
    rm /tmp/video00*.jpeg
